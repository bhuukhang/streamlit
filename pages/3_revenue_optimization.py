...
@st.cache_data
def load_data():
    category_next_month = pd.read_csv("predicted_category_revenue_next_month.csv")
    high_potential_customers = pd.read_csv("high_potential_customers.csv")
    revenue_by_state = pd.read_csv("predicted_revenue_by_state.csv")
    bundle_values = pd.read_csv("rq4_bundle_order_values.csv")
    price_analysis = pd.read_csv("price_analysis.csv")
    linear_models = joblib.load("linear_models_by_category.pkl")
    scaler = joblib.load("scaler.pkl")
    monthly_category_revenue = pd.read_csv("monthly_category_revenue.csv")
